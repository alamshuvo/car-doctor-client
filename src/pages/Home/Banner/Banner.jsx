        ...
        <Carousel.Slides>
          ...
          <Carousel.Item className="flex-[0_0_70%] [&:not(.is-snapped)]:opacity-[0.16]">
            <div className="relative w-full">
              <img className="rounded-xl" src={img1} alt="Carousel Item" />
              <div className="absolute md:flex hidden flex-col transform -translate-y-1/2 left-5 right-5  bg-gradient-to-r from-[#151515] to-[rgba(21,21,21,0)]  bottom-0 w-3/4 p-2 space-y-2  mt-4">
          ...
          <Typewriter
            words={['Affordable', 'Price', 'For', 'Car','Servicing']}
            loop={5}
            cursor
            cursorStyle='_'
            typeSpeed={70}
